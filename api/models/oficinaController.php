...
if($requestData['operacao'] == 'create'){
        ...
        try{
            ...
            $sql = "INSERT INTO oficina (nome_oficina, telefone, rua, bairro, numero) VALUES (?, ?, ?, ?, ?)"; // colocar ? para deixar mais seguro
    ...
    if($requestData['operacao'] == 'read'){
        ...
        $sql = "SELECT * FROM oficina WHERE 1=1 ";
